<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar personal</h2>
</div>
...
<div class="container pb-6 pt-6">
                    ...
                    <p class="control ">
                        <span class="select">
                            <select name="filtro_campo" required>
                                <option value="Idasesor">ID Usuario</option>
    ...
    <?php
            echo $insUsuario->listarPersonalControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
        }
    ?>
</div>