<div class="container is-fluid mb-4">
    ...
    <h2 class="subtitle"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar gastos</h2>
</div>
...
<div class="container pb-1 pt-1">
    <?php
        ...
        $insGastos = new expensesController();
                ...
                <p class="control">
                    <span class="select">
                        <select name="filtro_campo" required>
                            <option value="Idegreso">ID egreso</option>
    ...
    <?php
            echo $insGastos->listarGastoControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
        }
    ?>
    </div>