		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Descripcion <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="Descripcion" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,100}" maxlength="100" value="" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Costo <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="Costo" pattern="^\d{1,9}(\.\d{1,2})?$" maxlength="9" value="0.00" required >
				</div>
		  	</div>
		</div>
	<!--	<div class="columns">
