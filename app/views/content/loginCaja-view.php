...
.main-container {
    ...
    font-family: 'Poppins', sans-serif; /* Recomendado importar esta fuente */
}

/* Efecto de Cristal para la caja */
.box.login {
...
/* Títulos e iconos en blanco para contraste */
...
/* Animación sutil para el icono principal */
.icon-user {
...
<div class="main-container pb-3 pt-1">
    <form class="box login" action="" method="POST" autocomplete="off">
        ...
        <h5 class="title is-5 has-text-centered mb-5">Acceso a Caja</h5>

        <input type="hidden" name="login_almacen" value="1">

        <div class="field">
            <label class="label has-text-weight-normal">
                <i class="fas fa-lock margin-right-5"></i> Clave de acceso
            </label>
            <div class="control has-icons-left">
                <input class="input" type="password" name="login_clave" placeholder="••••••••" pattern="[-_a-zA-Z0-9$@.]{5,100}" maxlength="100" required>
            </div>
        </div>
