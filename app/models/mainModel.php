<?php
	...
	/*	protected function conectar(){
		...
		public static function conectar() {
			try {
				$conexion = new PDO(
					"mysql:host=".DB_SERVER.";dbname=".DB_NAME.";charset=utf8mb4",  // <-- AÑADIDO
					DB_USER,
					DB_PASS,
					[
				...
				// Esto fuerza correctamente todos los aspectos de codificación
	...
	/*	protected function ejecutarConsulta($consulta){
		...
		/*----------  Conexión a otra base de datos personalizada  ----------*/
	/*	protected function ejecutarConexionPersonalizada($almacen){
			try {
				...
				die("Error de conexión personalizada: " . $e->getMessage());
			}
		} */
